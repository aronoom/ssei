...
class __TwigTemplate_7fff81cc85c243e192a1dc7725aa9ddcf15c05a8e881e3f7f6472970adeeea8b extends Twig_Template
{
    ...
    {
        $__internal_a5f390ad962501d1aaf2f747c081a7f927c05375086458148547710a13165f6c = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_a5f390ad962501d1aaf2f747c081a7f927c05375086458148547710a13165f6c->enter($__internal_a5f390ad962501d1aaf2f747c081a7f927c05375086458148547710a13165f6c_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "IndicateurBundle:Subdivision:modifier.html.twig"));
    ...
    <div class=\"well\">
        <div class=\"item form-group\">
            <div class=\"control-label col-md-3\">
                ";
        // line 13
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "libelleSubdivision", array()), 'label', array("label" => "Libelle"));
        echo "
            </div>
            <div class=\"col-sm-6\">
                <li >
...
<script type=\"text/javascript\">
    \$('.formulaire').submit( function(event) {
        ...
        if (submit)
        {
            ...
            \$.ajax({
                url: Routing.generate('subdivision_modifier',{ id : \$id }),
                method : \"POST\",
                data : formData,
                processData: false,
                contentType: false,
...
";
        ...
        $__internal_a5f390ad962501d1aaf2f747c081a7f927c05375086458148547710a13165f6c->leave($__internal_a5f390ad962501d1aaf2f747c081a7f927c05375086458148547710a13165f6c_prof);
...
<form class=\"formulaire\" method=\"post\" {{ form_enctype(form) }} novalidate>
    <div class=\"well\">
        <div class=\"item form-group\">
            <div class=\"control-label col-md-3\">
                {{ form_label(form.libelleSubdivision,\"Libelle\")}}
            </div>
            <div class=\"col-sm-6\">
                <li >
