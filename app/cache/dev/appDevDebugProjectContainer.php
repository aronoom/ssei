...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Proc/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Proc/IndicateurBundle/Entity'), 2 => ($this->targetDirs[3].'/src/ZoneBundle/Entity')));
        ...
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UserBundle' => 'Proc\\UserBundle\\Entity', 'IndicateurBundle' => 'Proc\\IndicateurBundle\\Entity', 'ZoneBundle' => 'ZoneBundle\\Entity'));
